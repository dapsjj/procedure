...
/****** Object:  UserDefinedFunction [dbo].[FN_Year_GetJpanYear]    Script Date: 2019/04/20 14:44:07 ******/
SET ANSI_NULLS ON
GO
...
ALTER           FUNCTION  [dbo].[FN_Year_GetJpanYear]
 (@DATE DATETIME)
RETURNS VARCHAR(20)
...
BEGIN
  ...
  IF @DATE > '2019/4/30'
    BEGIN
      SET @GENGO = '令和'
      SET @WAYEAR = CONVERT(NVARCHAR(5), @YEAR-2018) 
    END
  ELSE IF @DATE > '1989/1/7'
    BEGIN
      SET @GENGO = '平成'
