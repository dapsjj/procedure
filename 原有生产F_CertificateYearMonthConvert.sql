...
/****** Object:  UserDefinedFunction [dbo].[F_CertificateYearMonthConvert]    Script Date: 2019/04/20 8:07:50 ******/
SET ANSI_NULLS ON
GO
...
CREATE function [dbo].[F_CertificateYearMonthConvert](@convertDate datetime)
Returns nvarchar(50)
as
begin
