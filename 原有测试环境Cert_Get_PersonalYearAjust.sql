...
/****** Object:  StoredProcedure [dbo].[Cert_Get_PersonalYearAjust]    Script Date: 2019/04/20 12:50:14 ******/
SET ANSI_NULLS ON
GO
...
--exec Taxwithholding_Get_PersonalYearAjust 22,1,457,1  
--***********************************************************************  
  
CREATE                                                           PROC [dbo].[Cert_Get_PersonalYearAjust]  
...
SET @SQL1 =  'SELECT (SELECT TOP 1 Name FROM dbEmployee.dbo.CertificateYearMonth WHERE ID = 1) AS 年月日
