...
/****** Object:  StoredProcedure [dbo].[Salary_BaseInfoOut]    Script Date: 2019/04/16 12:33:48 ******/
SET ANSI_NULLS ON
GO
...
set @str8=(select case when convert(nvarchar,SalaryOutput_Sum.item1)  is null  then '''''' else  'SalaryInformation.item'+convert(nvarchar,SalaryOutput_Sum.item1) end  
